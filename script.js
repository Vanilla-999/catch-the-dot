...
function addScore(points) {
    ...
    if (score > best) {
        ...
        scoreElem.parentElement.classList.add('new-record');
        setTimeout(() => {
            scoreElem.parentElement.classList.remove('new-record');
        }, 500);
    }
}
...
restartBtn.addEventListener('click', () => {
    score = 0;
    scoreElem.textContent = score;
    // тут можно сбросить все элементы игры, например позицию объектов
});
